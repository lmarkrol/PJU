...
driver = webdriver.Firefox(executable_path=r'C:\Users\t\Pictures\PJU\geckodriver.exe')  # Or Chrome(), or Ie(), or Opera()
...
saveDirectory = "C:/Users/t/Pictures/PJU/" + datetime.now().strftime('%d-%m-%Y') #%H-%M-%S')
