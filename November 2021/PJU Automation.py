...
driver = webdriver.Firefox(executable_path=r'C:\Users\t\Pictures\PJU\November 2021\geckodriver.exe')  # Or Chrome(), or Ie(), or Opera()
...
time.sleep(2) #perlu karna website pju ada delay dulu sebelum responsif
python_button.click()
...
saveDirectory = "C:/Users/t/Pictures/PJU/November 2021/" + datetime.now().strftime('%d-%m-%Y') #%H-%M-%S')
